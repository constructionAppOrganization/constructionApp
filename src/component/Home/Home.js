        ...
        <Modal.Body>
          <Row className="d-flex justify-content-center ">
            <div className="w-100 align-middle mh-100 d-flex justify-content-center ">
              <Form
                className="w-75 justify-content-center mb-5"
                onSubmit={login}
              >
                <Row className="d-flex justify-content-center align-items-center w-100">
                  <span
                    className={
                      invalidUserMsg
                        ? `home__invalidYouser_error_msg_visible`
                        : `home__invalidYouser_error_msg_hidden`
                    }
                  >
      ...
      >
        <div className="container">
          <a className="navbar-brand" href="#page-top">
            <img
              src="assets/img/7a67f2976c750a4c9055d4bf1dc646aa.png"
              alt="..."
            />
          </a>
          <button
          ...
          <div className="collapse navbar-collapse" id="navbarResponsive">
            <ul className="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
              ...
              <li
                className={auth ? `home__hide_adminPannel` : `nav-item`}
                onClick={handleShow}
              >
                <Button variant="warning" className="rounded-circle shadow">
                  Log In
                </Button>
              </li>
              <li className={auth ? `nav-item` : `home__hide_adminPannel`}>
      ...
      <header className="masthead">
        <div className="container">
          <div className="masthead-subheading">
            Welcome To Kuruduwaththa Construtions!
          </div>
              ...
              <div className="timeline-panel">
                <div className="timeline-heading">
                  ...
                  <h4 className="subheading">
                    Started Island wide Constructions
                  </h4>
                </div>
                <div className="timeline-body">
                  <p className="text-muted">
