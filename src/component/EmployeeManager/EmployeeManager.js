        ...
        <Container fluid>
          <Row>
            ...
            <Col md="10" xs="8" sm="9" className="supplierMainVeritcalDiv">
              ...
              <Switch>
                <Route
                  path="/adminPannel/EmployeeManager/employeeSalary"
                  exact
                  component={Employee}
                >
                ...
                <Route
                  path="/adminPannel/EmployeeManager/salaryReport"
                ...
                <Route
                  exact
                  path="/adminPannel/EmployeeManager/EmpHome"
                  component={EmpHome}
                >
                  <EmpHome></EmpHome>
                </Route>
                ...
                <Route
                  exact
                  path="/adminPannel/EmployeeManager/ReportHome"
                ...
                <Route
                  path="/adminPannel/EmployeeManager/EmployeeProject"
                ...
                <Route
                  path="/adminPannel/EmployeeManager/DisplayEmployee"
                ...
                <Route
                  path="/adminPannel/EmployeeManager/AddEmployee"
                ...
                <Route
                  exact
                  path="/adminPannel/EmployeeManager/EditEmployee"
                ...
                <Route
                  path="/adminPannel/EmployeeManager/EmployeeProfile"
                ...
                <Route
                  exact
                  path="/adminPannel/EmployeeManager/EmployeeReport"
                ...
                <Route
                  exact
                  path="/adminPannel/EmployeeManager/BarChart"
                  component={BarChart}
                >
                  <BarChart></BarChart>
                </Route>
                ...
                <Route
                  exact
                  path="/adminPannel/EmployeeManager/PieChart"
                  component={PieChart}
                >
                  <PieChart></PieChart>
                </Route>
