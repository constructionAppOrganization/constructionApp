    ...
    db.collection("Salary")
      ...
      .onSnapshot((querySnapshot) => {
        ...
        for (let i = 0; i < array1.length; i++) {
          ...
          array1[i].toBepaid =
            array1[i].data.amount - array1[i].data.ETF_amount;
  ...
  return (
    <div>
      ...
      <Container style={{ margin: "100px 100px 20px 480px" }}>
        <h2 className="text-warning" style={{ fontWeight: "18px" }}>
          Salary Report for Year {year} Month {month}
        </h2>
      </Container>
      <Container
        class="container"
        style={{ margin: "100px 300px 100px 100px", border: "5px" }}
      >
        <Col>
          <table
            align="center"
                ...
                .map((doc) => (
                  <tr>
                    <td style={{ textAlign: "left", verticalAlign: "middle" }}>
                      {doc.data.employee_name}
                    </td>
                    <td
                      style={{ textAlign: "center", verticalAlign: "middle" }}
                    >
                      {doc.data.basic_salary}
                    </td>
                    <td
                      style={{ textAlign: "center", verticalAlign: "middle" }}
                    >
      ...
      <Container>
        ...
        <Row>
          <Col>
            <Link to="/AdminPannel/EmployeeManager">
