...
export default function Ret_Project(props) {
  ...
  function deleteProject(currentPro) {
  ...
  useEffect(() => {
    editdb.get().then(
      (snapshot) => setProjectUp(snapshot.data()),
  ...
  function getSupAmount() {
    let suptot = 0;
    sup.map((amt) => (suptot = suptot + amt.data.fullAmount));
    return suptot;
  }
  //Client payments
  function getPay() {
    let payment = 0;
    pay.map((at) => (payment = at.data.amount + payment));
      ...
      .then((item) => {
        item.docs.map(
          (doc) => (
            ...
            clidb
              .collection("Salary")
              .where("employee_name", "==", doc.data().Employee)
              .get()
              .then((item) => {
                item.docs.map(
                  (doc) => (
  ...
  return (
    <div>
      ...
      >
        ...
        <Row>
          <Col>
            Client Name: <b>{clientDet}</b>
          </Col>
          <Col>
            Client Tp:<b>{client.phone}</b>{" "}
          </Col>
        </Row>
        <br />
        <br />
        ...
        <Row>
          <Col>
            Estimated Budget: <b>{budget}</b>{" "}
          </Col>
          <Col>
            Project Address: <b>{address}</b>
          </Col>
        </Row>
        <br />
        <br />
                      ...
                      <Table striped bordered hover>
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>
                              {sum(
                                con.data.advance_money,
                                con.data.first_phase,
                                con.data.second_phase,
                                con.data.EstimatedAmount
                              )}
                            </td>
          ...
          <Col>
            ...
            >
              ...
              <Modal.Body>
                ...
                <Col md={{ offset: 3 }}>
                  ...
                  <Row>
                    <Col md={{ offset: 2 }}>
                      <Row>
                        <h5>
                          <b>Suppliers Expense :</b> {getSupAmount()}
                        </h5>
                      </Row>
                      <Row>
                        <h5>
                          <b>Subcontracts Expense :</b> {Subamt}
                        </h5>
                      </Row>
                      <Row>
                        <h5>
                          <b>Employee Expense :</b> {sal}
                        </h5>
                      </Row>
                      <br />
                      <Row>
                        <h5>
                          <b>Total Expense:</b> {getSupAmount() + Subamt + sal}
                        </h5>
                      </Row>
                    </Col>
                  </Row>
                ...
                <Col>
                  <Row>
                    <Col>
                      <Row>
                        <h5>
                          <b>Amount After Expenses:</b>
                          {getPay() - (getSupAmount() + Subamt + sal)}{" "}
                        </h5>
                      </Row>
                    </Col>
                    <Col>
                ...
                <Row>
                  <h6>Budget over Expenses</h6>
                  <Pie data={data} />
                  <h1> </h1>
                  <h6>Budget over Client Payments</h6>
                  <Pie data={data2} />
                </Row>
                <Col></Col>
              </Modal.Body>
